...
class UIConsola:
    ...
    def iniciar_nuevo_juego(self):
        ...
        if not self.blackjack.jugador.mano.es_blackjack():
            ...
            self.blackjack.jugador.fichas += self.blackjack.apuesta_actual
            print(f"\nFichas de {self.blackjack.jugador.nombre}: {self.blackjack.jugador.fichas}")
...
#Desarrollo faltante
    def ejecutar_turno_de_la_casa(self):
        ...
        if self.blackjack.hay_empate():
            print("EMPATE. LA CASA Y TU TIENEN EL MISMO VALOR DE CARTAS")
        elif self.blackjack.jugador_gano():
            print("¡FELICITACIONES!\nLOGRASTE BLACKJACK. HAS GANADO EL JUEGO")
            self.blackjack.jugador.fichas += self.blackjack.apuesta_actual
        elif self.blackjack.casa_gano():
            print("HAS PERDIDO EL JUEGO. LA CASA HA GANADO")
            self.blackjack.jugador.fichas -= self.blackjack.apuesta_actual
        print(f"\nFichas de {self.blackjack.jugador.nombre}: {self.blackjack.jugador.fichas}")
